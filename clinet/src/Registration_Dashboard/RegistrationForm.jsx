...
//   // ✅ If admin opens this: navigate("/register", { state: { adminRegistration: true } })
...
//   // ✅ If admin is creating account → auto generate password
//   useEffect(() => {
//     if (isAdminRegistration) {
//       setFormData((prev) => ({
//         ...prev,
...
//     // ✅ Only validate password if student registering
//     if (!isAdminRegistration) {
//       if (!formData.password.trim())
//         tempErrors.password = "Password is required";
...
//     try {
//       // ✅ For student registration → remove role field (backend auto assigns STUDENT)
//       const payload = { ...formData };
//       if (!isAdminRegistration) delete payload.role;
...
//     } catch (error) {
//       setErrors({ general: error.response?.data || "Server error" });
//     }
//   };
...
//           <h2 className="fw-bold text-primary mb-3">
//             {isAdminRegistration ? "Create New Admin" : "Welcome!"}
//           </h2>
//         </div>
...
//                   <span className="position-absolute" style={{ right: "10px", top: "38px", cursor: "pointer" }}
...
//             {/* ✅ Role dropdown only visible for Admin */}
//             {isAdminRegistration && (
//               <div className="mb-3">
