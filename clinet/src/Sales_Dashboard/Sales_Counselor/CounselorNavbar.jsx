...
function CounselorNavbar() {
  const [openMenu, setOpenMenu] = useState(false);
  const [confirmLogout, setConfirmLogout] = useState(false);
  const navigate = useNavigate();

  // Fetch Counselor User from localStorage
  const user = (() => {
    try {
      return JSON.parse(localStorage.getItem("user")) || { firstName: "Counselor" };
    } catch {
      return { firstName: "Counselor" };
    }
  })();
          ...
          {openMenu && (
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setOpenMenu(false);
                  navigate("/sales-counselor/myprofile");
                }}
              >
      ...
      {confirmLogout && (
        ...
        >
          ...
          <div
            ...
            style={{ width: "380px", animation: "slideUp 0.3s ease" }}
          >
