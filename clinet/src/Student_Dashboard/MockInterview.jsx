...
const MockInterview = () => {
  ...
  const fetchPastInterviews = async () => {
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/api/interviews/student/${user.userId}`
      );
  ...
  const fetchLatestFeedback = async (interviewId) => {
    ...
    try {
      ...
      const res = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/api/ai/${interviewId}`
      );
  ...
  const handleStartInterview = async () => {
    ...
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/api/interviews/start`,
        requestDto
      );
