 ...
 * - onClose: fn
 * - onSuccess: fn
 * - roles: array of roles [{id, name}]
 * - loadingRoles: boolean
 * - apiBase: optional base URL override
 */
const AddUserForm = ({ onClose, onSuccess, roles = [], loadingRoles = false, apiBase = "http://localhost:8080" }) => {
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      ...
      // backend sends DuplicateFieldException with message "Email already exists!" or "Phone already exists!"
